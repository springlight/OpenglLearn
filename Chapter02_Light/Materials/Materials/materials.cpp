   ...
   // ------------------------------------------------------------------
	...
	while (!glfwWindowShouldClose(window)) {
	   ...
	   // ------
		...
		materialsShader.setVec3("light.specular", 1.0, 1.0f, 1.f);
	
		materialsShader.setVec3("material.ambient", 1.0f, 0.5f, 0.31f);
		materialsShader.setVec3("material.diffuse", 1.0f, 0.5f, 0.31f);
		materialsShader.setVec3("material.specular", 0.5f, 0.5f, 0.5f); // specular lighting doesn't have full effect on this object's material
